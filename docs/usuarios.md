...
* `username` - String Debe tener al menos 3 caracteres y no puede
contener espacios.
* `email` - String
* `phone` - int, Debe ser por lo menos de 10 digitos y  empezar por 3.
...
* `name` - String Debe tener al menos 3 caracteres y no puede contener
espacios.
* `lastname` - String Debe tener al menos 3 caracteres y no puede contener
espacios.
